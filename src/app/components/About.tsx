...
<div className="space-y-4">
  ...
  <div className="space-y-4 text-base text-muted-foreground leading-relaxed">
    <p>
      ...
      學會如何為一本好書「定錨」，並透過內容行銷擴散作者與書籍知名度，進而帶動銷量；在{" "}
      <a
        href="https://www.vpon.com/zh-hant/"
        target="_blank"
        rel="noopener noreferrer"
        className="text-foreground underline hover:no-underline"
      >
      ...
      看見大數據背後的廣告運作邏輯，也開始建立對數據與投放之間關係的理解；並在{" "}
      <a
        href="https://vocus.cc/become_creator"
        target="_blank"
        rel="noopener noreferrer"
        className="text-foreground underline hover:no-underline"
      >
      ...
      迎來職涯的關鍵跳躍 —— 學會以數據導向思維推進數位行銷策略，並帶領團隊實現單月 GMV 成長與千萬級流量。
    </p>
...
<div className="space-y-4">
  ...
  <div className="space-y-4 text-base text-muted-foreground leading-relaxed">
    <p>
      我的現職品牌雖屬傳統產業，卻販售最前沿的科技產品 —— 電動車。這樣的交界碰撞，使數位轉型成為必然；而我所屬團隊也成功落地全線上購車下訂模式，並推動精品配件線上購的實績。
    </p>
    <p>
      在過程中，我專注於全線上購車與試駕流程的轉換與優化，透過流程設計與數據分析，降低使用者的決策門檻，提升整體轉換效率。
    </p>
  </div>
</div>
</div>
